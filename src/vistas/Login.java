...
public class Login extends javax.swing.JFrame {
    ...
    private boolean estaRegistrado() {
        for (Personal personal : ValoresGlobales.personal) {
            if (txtUser.getText().equals(personal.codigo) && String.valueOf(txtPassword.getPassword()).equals(personal.password)) {
                ValoresGlobales.codigoUsuarioActual = personal.codigo;
                ValoresGlobales.nombreUsuarioActual = personal.nombre;
                return true;
            }
        }
        return false;
